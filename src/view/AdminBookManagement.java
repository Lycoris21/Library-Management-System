...
public class AdminBookManagement extends JFrame {
    ...
    private void initComponents() {
        ...
        addBookButton.addActionListener(evt -> openAddBookDialog());
        add(addBookButton);
    ...
    private void openAddBookDialog() {
        AddBookModal addBookDialog = new AddBookModal(this, true);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new AdminBookManagement().setVisible(true));
    }
}
