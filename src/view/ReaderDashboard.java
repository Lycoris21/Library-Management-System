...
//        username.setIcon(pp);
        ...
        reservationsc = new JLabel("" + bookC.getUserCurrentlyReservedCount(currentUser), SwingConstants.CENTER);
        ...
        borrowingc = new JLabel("" + bookC.getUserCurrentlyBorrowingCount(currentUser), SwingConstants.CENTER);
        ...
        overduec = new JLabel("" + bookC.getUserCurrentlyOverdueCount(currentUser), SwingConstants.CENTER);
...
// Get latest transactions from BorrowingController
        List<Borrowing> latestTrans = borrowC.getUserLatestTransactions(currentUser);
