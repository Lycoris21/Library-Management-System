...
//        username.setIcon(pp);
        ...
        private void handleAction() {
            ...
            if (action.equals("More Details")) {
                try {
                    ...
                    if (rowIndex < 0) {
                        JOptionPane.showMessageDialog(LibrarianRecords.this, "Please select a record to view details.", "Error", JOptionPane.ERROR_MESSAGE);
                    ...
                    if (status.equals("Reserved") || status.equals("Voided")) {
                        ...
                        RecordController.ReservationDetails reservationDetails = recordC.getReservationDetails(reservationId);
                        ...
                        RecordController.BorrowingDetails borrowingDetails = recordC.getBorrowingDetails(borrowingId);
                    ...
                    JOptionPane.showMessageDialog(LibrarianRecords.this, "An error occurred while retrieving details. Please try again.", "Error", JOptionPane.ERROR_MESSAGE);
                }
            }
        }
    }
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new LibrarianRecords().setVisible(true));
    }  
}
